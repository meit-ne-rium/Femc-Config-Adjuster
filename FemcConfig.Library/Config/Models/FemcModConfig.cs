...
public partial class FemcModConfig : ObservableObject
{
    ...
    [ObservableProperty] private ConfigColor _MindWindowOuterHazeEx = new ConfigColor(0xFF, 0x89, 0xA6, 0x80);
    ...
    [ObservableProperty] private ConfigColor _MsgSimpleSelectBoxShadow = new ConfigColor(0xB6, 0x3F, 0x67, 0xFF);
    ...
    [ObservableProperty] private ConfigColor _BattleResultLeftSquare = new ConfigColor(0x6E, 0x03, 0x0E, 0xFF);
    [ObservableProperty] private ConfigColor _BattleResultLeftZeroFontColor = new ConfigColor(0xEB, 0x44, 0x7D, 0xFF);
    [ObservableProperty] private ConfigColor _BattleResultFontColor = new ConfigColor(0xFD, 0x9B, 0xB7, 0xFF);
    ...
    [ObservableProperty] private ConfigColor _StatsShadowsColor = new ConfigColor(0x66, 0x08, 0x29, 0xFF);
    ...
    [ObservableProperty] private ConfigColor _CampMenuSystemItemColorNoSel = new ConfigColor(0xFF, 0xB2, 0x9E, 0xFF);
    ...
    [ObservableProperty] private ConfigColor _CampConfigUnk = new ConfigColor(0x8f, 0x65, 0x73, 0xff);
    ...
    [ObservableProperty] private ConfigColor _SaveLoadScrollBar = new ConfigColor(0x69, 0x03, 0x36, 0xFF);
    ...
    [ObservableProperty] private ConfigColor _CampSystemStartFadeColor = new ConfigColor(0x9f, 0x04, 0x38, 0xff);
    ...
    [ObservableProperty] private ConfigColor _Assault1Keyframe1 = new ConfigColor(0xFF, 0x00, 0x01, 0x00);
    [ObservableProperty] private ConfigColor _Assault1Keyframe2 = new ConfigColor(0xFF, 0x00, 0x16, 0x36);
    [ObservableProperty] private ConfigColor _Assault1Keyframe3 = new ConfigColor(0xFF, 0x00, 0x1A, 0x5B);
    [ObservableProperty] private ConfigColor _Assault1Keyframe4 = new ConfigColor(0x8C, 0x00, 0x27, 0xFF);
    [ObservableProperty] private ConfigColor _Assault1Keyframe5 = new ConfigColor(0x8C, 0x00, 0x1C, 0x00);
    [ObservableProperty] private ConfigColor _Assault2Keyframe1 = new ConfigColor(0xFF, 0x03, 0x13, 0x00);
    [ObservableProperty] private ConfigColor _Assault2Keyframe2 = new ConfigColor(0xFF, 0x02, 0x16, 0xFF);
    [ObservableProperty] private ConfigColor _Assault2Keyframe3 = new ConfigColor(0xFF, 0x01, 0x2A, 0xFF);
    [ObservableProperty] private ConfigColor _Assault2Keyframe4 = new ConfigColor(0x8D, 0x00, 0x20, 0x8D);
    ...
    [ObservableProperty] private ConfigColor _AssaultBallsKeyframe2 = new ConfigColor(0xFF, 0x2F, 0x4D, 0xFF);
    [ObservableProperty] private ConfigColor _AssaultBallsKeyframe3 = new ConfigColor(0xFF, 0x00, 0x59, 0xFF);
    [ObservableProperty] private ConfigColor _AssaultBallsKeyframe45 = new ConfigColor(0xFF, 0x00, 0x19, 0xFF);
    [ObservableProperty] private ConfigColor _ShiftCharacterHighlightKeyframe1 = new ConfigColor(0xF5, 0x8E, 0xBB, 0xCC);
    [ObservableProperty] private ConfigColor _ShiftCharacterHighlightKeyframe2 = new ConfigColor(0xFF, 0xA6, 0xC6, 0xCA);
    [ObservableProperty] private ConfigColor _ShiftLinesKeyframe1 = new ConfigColor(0xFF, 0x69, 0x69, 0xFF);
    [ObservableProperty] private ConfigColor _ShiftLinesKeyframe2 = new ConfigColor(0xFF, 0x09, 0x0D, 0xFF);
    [ObservableProperty] private ConfigColor _ShiftLinesKeyframe3 = new ConfigColor(0xFF, 0x05, 0x09, 0xFF);
    [ObservableProperty] private ConfigColor _ShiftLinesKeyframe4 = new ConfigColor(0xFF, 0x03, 0x07, 0x00);
    [ObservableProperty] private ConfigColor _ShiftAdditionalLines = new ConfigColor(0xFF, 0x02, 0x04, 0xFF);
    [ObservableProperty] private ConfigColor _UnselectedRipple1 = new ConfigColor(0xD9, 0x75, 0x8D, 0xFF);
    [ObservableProperty] private ConfigColor _UnselectedRipple2 = new ConfigColor(0xBA, 0x65, 0x79, 0xFF);
    [ObservableProperty] private ConfigColor _UnselectedRipple3 = new ConfigColor(0xA3, 0x58, 0x6A, 0xFF);
    [ObservableProperty] private ConfigColor _RegisteredStatsBg = new ConfigColor(0x4B, 0x2B, 0x35, 0xFF);
    [ObservableProperty] private ConfigColor _RegisteredStatsArrowsBg = new ConfigColor(0x7B, 0x5A, 0x64, 0xFF);
    [ObservableProperty] private ConfigColor _RegisteredStatsButtonOutline = new ConfigColor(0x6E, 0x4A, 0x54, 0xFF);
    [ObservableProperty] private ConfigColor _RegisteredStatsUnhighlightedFont = new ConfigColor(0x94, 0x74, 0x7C, 0xFF);
    [ObservableProperty] private ConfigColor _CmmuRankUpSparkles1 = new ConfigColor(0xFF, 0x59, 0x90, 0xFF);
    [ObservableProperty] private ConfigColor _CmmuRankUpSparkles2 = new ConfigColor(0xFF, 0x0F, 0x17, 0xFF);
    [ObservableProperty] private ConfigColor _CmmuRankUpSparkles3 = new ConfigColor(0x9E, 0x00, 0x10, 0xFF);
